...
#define DEF_FREQUENCY_UP_THRESHOLD			(90)	// ZZ: default regular scaling up threshold
...
#define DEF_SMOOTH_UP					(80)	// ZZ: default cpu load trigger for 'boosting' scaling frequency
#define DEF_FREQUENCY_DOWN_THRESHOLD			(42)	// ZZ: default regular scaling down threshold
#ifdef ENABLE_HOTPLUGGING
