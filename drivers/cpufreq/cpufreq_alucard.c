...
#define DEFAULT_TIMER_RATE_SUSP ((unsigned long)(40 * USEC_PER_MSEC))

#define FREQ_RESPONSIVENESS		 650000
#define FREQ_RESPONSIVENESS_MAX		1066000
#define FREQ_RESPONSIVENESS_BIGC	 936000
#define FREQ_RESPONSIVENESS_MAX_BIGC	1352000
...
struct cpufreq_alucard_tunables {
	 ...
	 * above minimum before wakeup to reduce speed, or -1 if unnecessary. was 3
	 */
